...
| `/add-cards` | — (opens a multi-line form popup) | Add multiple cards at once; one per line, semicolon-delimited: `name;qty;price[;condition[;set[;foil]]]` (semicolons avoid ambiguity with commas in card names like "Muldrotha, the Gravetide") |
